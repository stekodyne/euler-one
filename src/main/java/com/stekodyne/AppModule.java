...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("8938417871986030560 5db36c5c-877b-429b-b0f5-1146eccfa5ef euler Euler".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in com.stekodyne package as a set of config entries
        return configLoader.fromResource("com/stekodyne/settings");
    }
